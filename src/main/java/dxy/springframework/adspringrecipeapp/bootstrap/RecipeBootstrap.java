package dxy.springframework.adspringrecipeapp.bootstrap;

import dxy.springframework.adspringrecipeapp.domain.*;
...
public class RecipeBootstrap implements CommandLineRunner {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("http://www.dxy.com");
        guacRecipe.setSource("from master austin");
